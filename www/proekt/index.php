						...
						<li>
							<div class="box_pink">
								<div class="img"><img src="images/4.jpg" width="620" height="300" alt="1" /></div>
									<div class="right">
										<div class="title">Відпочинок на морі в Туреччині</div>
										<p>Відпочинок на морі в Туреччині ніколи не вийде з моди. Чисте море, приємний клімат, All Inclusive та цікаві екскурссіі - все це подарує вам пляжний відпочинок в Туреччині.</p>
									</div>
							</div>
          <!--end box pink-->
						</li>
						<li>
							<div class="box_green">
								<div class="img"><img src="images/5.jpg" width="620" height="300" alt="1" /></div>
									<div class="right">
										<div class="title">Пляж і море в сонячній Болгарії</div>
										<p>Цілий рік ця країна гостинна і розташовує до повноцінного відпочинку. Але перш за все ми знаємо Болгарію як відмінний і недорогий літній курорт з теплим морем, першокласними пляжами, ласкавим сонцем і цілющим мікрокліматом.</p>
									</div>
								</div>
          <!--end box green-->
						</li>
